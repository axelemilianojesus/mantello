        ...
        <div class="col-md-12">
          ...
          <div class="card card-cascade wider reverse">
            ...
            <div class="view view-cascade overlay">
              <img class="card-img-top" src="img/carrito/compra-segura-monetize.png" alt="compra-segura-monetize">
              <a href="#!">
            ...
            <div class="card-body card-body-cascade text-center">
              ...
              <!-- Title -->
              <h3 class="font-weight-bold"><a>CÓMO COMPRAR</a></h3>
              <!-- Data -->
              <p>Nuestro proceso de compra garantizado</p>
