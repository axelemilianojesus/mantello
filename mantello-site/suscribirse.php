...
y recibi nuestras mejores ofertas.</p>
        ...
        <div class="social text-center">
          <a class="mx-1" href="#"><i class="fab fa-facebook-f p-2 rounded"></i></a>
          <a class="mx-1" href="#"><i class="fab fa-twitter p-2 rounded"></i></a>
          <a class="mx-1" href="#"><i class="fab fa-linkedin-in p-2 rounded"></i></a>
          <a class="mx-1" href="#"><i class="fab fa-instagram p-2 rounded"></i></a>
        </div>
